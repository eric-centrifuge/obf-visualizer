...
export class Event implements IEvent {
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["name"] = this.name;
        data["date"] = this.date ? formatDate(new Date(this.date)) : <any>undefined;
...
export interface IEvent {
    /** String containing the title of this event. This is a required field. */
    name: string;
    /** String containing the state of this event. This is a required field. */
    state: EventState.Open | EventState.Pending | EventState.Started | EventState.Completed | EventState.Finalized;
    /** Start date of the event. Should be provided in ISO 8601 format (YYYY-MM-DD). */
    date: string;
    /** String representing the name of the game played at this event. */
    gameName: string;
